    ...
    <div className="card border-amber-200 dark:border-amber-800 px-4 py-3 flex gap-2.5 items-start">
      ...
      <p className="flex-1 text-sm text-sub">
        <span className="font-medium text-ink">
          {activityCount} location{oneLocation ? "" : "s"} near {placeList}{" "}
          {oneLocation ? "has" : "have"} no nearby lodging.
        </span>{" "}
        ...
        {oneLocation ? "It" : "They"} won&rsquo;t be scheduled unless a lodging
        covers {onePlace ? "that area" : "those areas"} — add one, or this is
        fine if a trip to {placeList} isn&rsquo;t on the itinerary.
      </p>
      <button
