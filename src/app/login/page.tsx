  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col gap-6 pt-16">
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-sm text-sub">This trip planner is private. Enter the password to continue.</p>
      </div>
      <form action={login} className="flex flex-col gap-3">
        ...
        />
        {failed && <p className="text-sm text-danger-600 dark:text-danger-400">Wrong password.</p>}
        <button
          type="submit"
